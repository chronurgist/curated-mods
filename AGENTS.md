...
* Current: 169 mods, with EMI as the primary recipe viewer, plus EMI Loot/Ores and JEI compatibility, Relics and Reliquified addons for trinket progression, Fresh Animations support via EMF/ETF, CompactMachinesPOR as the 1.21.1 Compact Machines implementation, Ars Énergistique integrating Applied Energistics 2 with Ars Nouveau, GeOre adding geodes, and Super Factory Manager providing logistics automation. Intentionally excludes Refined Storage.
