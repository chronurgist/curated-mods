...
* Current: 154 mods, EMI (with EMI Loot/Ores + Fzzy Config) replaces JEI, CompactMachinesPOR is the 1.21.1 Compact Machines, and Ars Énergistique integrates Applied Energistics 2 with Ars Nouveau. Intentionally excludes Refined Storage.
...
* 26.1 port: see `26.1-neoforge-compatibility.md` (98/154 have 26.1+neoforge Modrinth file, 22 no, 34 CurseForge-only need manual CF check). Branch before bumping `pack.toml` versions.
