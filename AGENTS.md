...
* Current: 156 mods, EMI (with EMI Loot/Ores + Fzzy Config) replaces JEI, CompactMachinesPOR is the 1.21.1 Compact Machines, Ars Énergistique integrates Applied Energistics 2 with Ars Nouveau, GeOre adds geodes, and Super Factory Manager provides logistics automation. Intentionally excludes Refined Storage.
